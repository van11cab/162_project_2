    ...
    for file in imgdirectory:
        ...
        for x in range(minImage.width): #testing purposes
            for y in range(minImage.height):
                ...
                #r
                if currpixel[0] > currmax[0]-10:
                    R = currmax[0]-10
                elif currpixel[0] < currmin[0]+10:
                    R = currmin[0]+10
                else:
                    R = currpixel[0]
                
                #g
                if currpixel[1] > currmax[1]-10:
                    G = currmax[1]-10
                elif currpixel[1] < currmin[1]+10:
                    G = currmin[1]+10
                else:
                    G = currpixel[1]
                
                #B
                if currpixel[2] > currmax[2]-10:
                    B = currmax[2]-10
                elif currpixel[2] < currmin[2]+10:
                    B = currmin[2]+10
                else:
                    B = currpixel[2]
